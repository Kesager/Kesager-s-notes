...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: '仅仅只是用 <span style="color: #e25555;">&#9829;</span> 撰写',
      copyright:
        '<a class="footer-cc-link" target="_blank" href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a> © 2024-PRESENT Kessager AllRightsReserved.',
    },
    search: {
      provider: 'local',
      options: {
